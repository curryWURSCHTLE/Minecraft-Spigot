...
public class Charger extends ZombieMob {
	...
	public Charger() {
		super(ZombieMobType.CHARGER, null);
		this.values = new ZombieMobValues(ZombieMobType.CHARGER);
		this.type = ZombieMobType.CHARGER;
	}
	...
	public void create(ZombieMobType type, Location loc) {
		Entity entity = ((CraftWorld) loc.getWorld()).spawnEntity(loc, EntityType.POLAR_BEAR);
