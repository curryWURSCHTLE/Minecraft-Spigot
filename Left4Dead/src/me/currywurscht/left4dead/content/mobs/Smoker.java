...
public class Smoker extends ZombieMob {
	...
	public Smoker() {
		super(ZombieMobType.SMOKER, new ZombieMobValues(ZombieMobType.SMOKER));
		this.values = new ZombieMobValues(ZombieMobType.SMOKER);
		this.type = ZombieMobType.SMOKER;
	}
